...
namespace IssueBoard.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IssueActivities_Users_ActorUserId",
            ...
            migrationBuilder.CreateTable(
                name: "IssueIssueLabels",
                columns: table => new
                {
                    IssueId = table.Column<Guid>(type: "uuid", nullable: false),
                    IssueLabelId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueIssueLabels", x => new { x.IssueId, x.IssueLabelId });
                    table.ForeignKey(
                        name: "FK_IssueIssueLabels_IssueLabels_IssueLabelId",
                        column: x => x.IssueLabelId,
                        principalTable: "IssueLabels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IssueIssueLabels_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueActivities_ActorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueIssueLabels_IssueLabelId",
                table: "IssueIssueLabels",
                column: "IssueLabelId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueLabels_ProjectId_Name",
                table: "IssueLabels",
