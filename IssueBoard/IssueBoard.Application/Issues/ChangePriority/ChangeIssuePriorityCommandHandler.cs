...
public sealed class ChangeIssuePriorityCommandHandler
    : ICommandHandler<ChangeIssuePriorityCommand, IssueDto>
{
    ...
    public ChangeIssuePriorityCommandHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        issue.ChangePriority(request.Priority, request.RequesterUserId);
